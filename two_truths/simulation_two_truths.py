...
palette_gw = {'Left':(0.7,0.5,0.2),
           'Right':(0.1,0.8,0.5)}
lse_kmeans = KMeans(n_clusters=2).fit_predict(lse_Xhat)
lse_kmeans_labels = (4 * n_verts) * ['Left']
labels_gw = n_verts * [0] + n_verts * [0] + n_verts * [1] + n_verts * [1] #true label
lse_ari = adjusted_rand_score(labels_gw, lse_kmeans)
lse_error = labels_gw - lse_kmeans
